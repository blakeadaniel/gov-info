...
const SectionOptionContainer = styled(
  TouchableOpacity
)`wp100 h4 ph2 jcc flx-row jcsb mb1`;
...
export function SectionOption({
  ...
  return (
    <SectionOptionAndLineDivider style={style}>
      <SectionOptionContainer onPress={handleOnPress}>
